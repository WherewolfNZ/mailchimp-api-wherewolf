...
(function() {
  ...
  Lists = (function() {
    ...
    Lists.prototype.batchSubscribe = function(params, onsuccess, onerror) {
      ...
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      if (params["double_optin"] == null) {
        params["double_optin"] = true;
      }
      if (params["update_existing"] == null) {
        params["update_existing"] = false;
      }
      if (params["replace_interests"] == null) {
    ...
    Lists.prototype.batchUnsubscribe = function(params, onsuccess, onerror) {
      ...
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      if (params["delete_member"] == null) {
        params["delete_member"] = false;
      }
      if (params["send_goodbye"] == null) {
        params["send_goodbye"] = true;
      }
      if (params["send_notify"] == null) {
  ...
  Campaigns = (function() {
    ...
    Campaigns.prototype.create = function(params, onsuccess, onerror) {
      ...
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      if (params["segment_opts"] == null) {
        params["segment_opts"] = null;
      }
      if (params["type_opts"] == null) {
    ...
    Campaigns.prototype.schedule = function(params, onsuccess, onerror) {
      ...
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      if (params["schedule_time_b"] == null) {
    ...
    Campaigns.prototype.scheduleBatch = function(params, onsuccess, onerror) {
      ...
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      if (params["num_batches"] == null) {
        params["num_batches"] = 2;
      }
      if (params["stagger_mins"] == null) {
    ...
    Campaigns.prototype.sendTest = function(params, onsuccess, onerror) {
      ...
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      if (params["test_emails"] == null) {
        params["test_emails"] = [];
      }
      if (params["send_type"] == null) {
  ...
  Gallery = (function() {
    ...
    Gallery.prototype.listFolders = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      ...
      return this.master.call('gallery/list-folders', params, onsuccess, onerror);
    };
    ...
    Gallery.prototype.addFolder = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      return this.master.call('gallery/add-folder', params, onsuccess, onerror);
    };
    ...
    Gallery.prototype.removeFolder = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      return this.master.call('gallery/remove-folder', params, onsuccess, onerror);
    };
    ...
    Gallery.prototype.addFileToFolder = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      return this.master.call('gallery/add-file-to-folder', params, onsuccess, onerror);
    };
    ...
    Gallery.prototype.removeFileFromFolder = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      return this.master.call('gallery/remove-file-from-folder', params, onsuccess, onerror);
    };
    ...
    Gallery.prototype.removeAllFilesFromFolder = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      return this.master.call('gallery/remove-all-files-from-folder', params, onsuccess, onerror);
    };
  ...
  Goal = (function() {
    ...
    Goal.prototype.events = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      ...
      return this.master.call('goal/events', params, onsuccess, onerror);
    };
    ...
    Goal.prototype.recordEvent = function(params, onsuccess, onerror) {
      var _ref;
      if (params == null) {
        params = {};
      }
      _ref = this.master.parseArgs(params, onsuccess, onerror), params = _ref[0], onsuccess = _ref[1], onerror = _ref[2];
      return this.master.call('goal/record-event', params, onsuccess, onerror);
    };
